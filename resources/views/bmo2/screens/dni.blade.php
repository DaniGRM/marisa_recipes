        ...
        <div class="bmo-dni">
            <div class="container-fluid w-100 h-100">
                ...
                <div class="bmo-dni-points-badge">
                    ...
                    <span class="bmo-dni-points"> <img style="margin-bottom: 18px;" src="/card/coin.png" alt="Coin Icon"> {{ $dniUser->current_month_points }}</span>
                </div>
                ...
                <div class="bmo-dni-resume">
                    <div class="w-50 p-3">
                        ...
                        <span class="d-flex w-100 justify-content-center align-items-center" style="font-size: 4rem; height: 90%;">
                            5
                        </span>
