...
<div class="bmo-screen" data-screen="flash_moving">
    ...
    <div class="row justify-content-between align-items-center h-25">
        @foreach($users as $user)
            
        <div class="col-6">
            <div class="row">
                <div class="col-12">
                    <p class="bmo-dni-user-points-label user{{ $user->id }}">{{ $user->name }}</p>
                </div>
                <div class="col-6 d-flex align-items-center" style="font-size: 2rem">
                    <p class="me-3">{{ $user->flash_moving_boxes }}</p><img style="width: 60px; height: auto; margin-bottom: 1rem" src="card/box.png" alt="">
                </div>
                <div class="col-6 d-flex align-items-center" style="font-size: 2rem">
                    <p class="me-3">{{ $user->flash_moving_points }}</p><img style="width: 60px; height: auto; margin-bottom: 1rem" src="card/coin.png" alt="">
                </div>
            </div>
        ...
        <!-- <div class="col-6">
            <div class="row">
                <div class="col-12">
                    <p class="bmo-dni-user-points-label user1">CARMEN</p>
                </div>
                <div class="col-6 d-flex align-items-center" style="font-size: 2rem">
                    <p class="me-3">10 </p><img style="width: 60px; height: auto; margin-bottom: 1rem" src="card/box.png" alt="">
                </div>
                <div class="col-6 d-flex align-items-center" style="font-size: 2rem">
                    <p class="me-3" >10</p><img style="width: 60px; height: auto; margin-bottom: 1rem" src="card/coin.png" alt="">
                </div>
            </div>
        </div> -->
        @endforeach
